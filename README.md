...
- 🌱 Exploring **Spring Boot**, **React (TS)**, **Docker**, **Cloud DevOps**
- 🛠️ Building scalable backends with **Java**, **PostgreSQL**, and **REST APIs**
- 🧠 Learning about **Microservices** and **Kubernetes**
